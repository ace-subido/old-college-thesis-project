...
%>    
		...
		<div class="column1-unit">
                    <h1 class="side"><img src="icons/events-icon.jpg" alt="Image description" title="Image title" />Events Approval Service</h1>
                    <h3 class="side">&nbsp;</h3>
                    ...
                    <ul>
                        <li> <a href="residentCreateEvent1.jsp">Create Event</a></li>                  
                        <li> <a onclick='showAllEventHistory()'>View Event History</a></li>                  
                    </ul>
                </div>     
                <hr class="clear-contentunit" />
                <div class="column1-unit">
                    <h1>My Upcoming Events</h1>   <br>
                </div>
