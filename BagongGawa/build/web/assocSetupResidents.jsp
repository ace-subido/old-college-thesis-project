...
%>
            ...
            <div class="main-content">
                <h1 class="pagetitle">Setting up your Community's Resident Account &nbsp; </h1>

                <!-- Content unit - One column -->
                <div class="column1-unit">
                    <div class="contactform">
                    <center>
                    <p><h2>Does your community have a master list of residents?</h2><br>
                        (e.g. a list of residents and their information in excel)
                        </p><br><br>
                        <p>
                            <input type="button" value="Yes" onclick="window.location.href='assocUpload2.jsp'">
                            <input type="button" value="No" onclick="window.location.href='assocSetupResidentsManual.jsp'">
                        </p>
                    </center>
                    </div>
                </div>
