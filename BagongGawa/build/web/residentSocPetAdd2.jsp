...
%>
                ...
                <div class="column1-unit">
                    <p class="center"><img class="center" src="./icons/sgRes-createpet2.jpg" alt="Image description" title="Image title" /></p>        
                    <p>This step is called Invite Residents, in order to move on to the next step you must invite residents and at least <%=lololol%> should accept the invitation to join you in forming this petition request so that the staff can approve of it. </p>   
                </div>        
                <hr class="clear-contentunit" />    
                <div class="column1-unit">     
                    <h1 class="block">2 - Invite Residents : Resident List</h1>
<%
                    if(vr==null)
                    {
%>
...
%>
                ...
                <div id="jiankang" name="jiankang" class="column2-unit-left">        
                    <p>Search Residents:<br>
                        ...
                        <input type="button" name="SearchResident" value="Search Resident" onclick="displayResident()"/>
                    </p>
                ...
                <hr class="clear-contentunit"/>    <br>
                <p>    <input type="button" class="button" name="SearchResident" value="Back" onclick="window.location.href='residentSocPetAdd.jsp'"/>     
                <input type="button" class="button" name="SearchResident" value="Next" onclick="window.location.href='processResidentSocPetAdd3.jsp'"/>        </p>
            </div>
        </div>
        <!-- C. FOOTER AREA -->      
        <div class="footer">
