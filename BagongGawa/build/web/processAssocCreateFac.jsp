...
<%	
	...
	if (formT.equals("new"))
	{
		...
		response.sendRedirect("assocFacilities.jsp");
		}
		else{
		...
		%>
			...
			<!--
				...
				location = "assocCreateFac.jsp?facility=0";
			-->
			</script>
			<%
	...
	if(formT.equals("old"))
	{
		...
		if(dick.equals(cum))
		{
			...
			response.sendRedirect("assocCreateFac.jsp?facility="+temp+"");
		}
		...
		%>
			...
			<!--
				...
				alert("That facility already exists");
				location = "assocCreateFac.jsp?facility=" + wtf;
			-->
			</script>
			<%
