...
<html>
    ...
    <body>
        ...
        <% 
        int a = Integer.parseInt(request.getParameter("eleccutdate"));
        int b = Integer.parseInt(request.getParameter("elecpaydate"));
        double c = Double.parseDouble(request.getParameter("efee"));
        
        Billing bl = new Billing();
        
        double cc = bl.roundTwoDecimals(c);
        
        bl.updateElecSettings(a, b, cc);
        ...
        <script type= "text/javascript">
			<!--
				...
				alert("Electricity Bill Settings Saved!");
