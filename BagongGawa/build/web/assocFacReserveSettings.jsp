...
%>
            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    ...
                    <br><br><a href="assocReservationList.jsp">Back to Reservation List</a></p>
                </div> 
                <!-- Content unit - One column -->
                <hr class="clear-contentunit" />
                <div class="column1-unit">
                    <div class="contactform" id="pupu">          
                        <form name="facresset" method="post" onsubmit='return(checklist())' action="assocFacReserveSettings2.jsp">
                            <fieldset>
                                <legend>&nbsp;FACILITY RESERVATION SETTINGS&nbsp;<font color="red">1</font> 2</legend>
                                <p><label for="contact_familyname" class="left">Choose Facility:</label>
                                <select id="co" class="combo" name="tit" >
