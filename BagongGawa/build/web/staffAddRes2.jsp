            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    <div class="contactform" align="center">
                        <table width="636"> 
                            <tr>
                                <th width="150" class="top" scope="col"><div align="center">Address</div></th>
                                <th width="82" class="top" scope="col"><div align="center">Status</div></th>
                            </tr>
<%
...
%>                           
                            <tr>
                                <td>
                                    <div align="center">
                                        <%=lotSet.getString("address")%>
                                    </div>    
                                </td>
<%
                                if(lotSet.getString("Status").equalsIgnoreCase("Occupied"))
                                {    
%>
                                <td>
                                    <div align="center">
...
%>
                                <td>
                                    <div align="center">
                                        <a href="staffAddRes3.jsp?resId=<%=resId%>&lotid=<%=lotSet.getInt("lid")%>">Unoccupied</a>
                                    </div>    
                                </td>
<%
                                }    
