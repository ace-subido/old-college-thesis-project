...
<script type= "text/javascript">
    function checkForm()
    {
        var isCheck = confirm("Are you sure you want to delete this permit?");
        var go;
        if (isCheck)
            go = true;
        else
...
<%
    ...
    String id = request.getParameter("permitID");
    
    CachedRowSet checkSet = p.getCheckDetails(id);
    CachedRowSet fieldSet = p.getFieldDetails(id);
...
%>
            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    ...
                    <p>Below are the list of details needed for car sticker permit application. Please select the details that you wish to apply in your permit.</p>
                <%
                    if(checkSet.size() != 0 && fieldSet.size() != 0)
                    {
                        ...
                        {
                %>
                            <form name="permit" onSubmit="return(checkForm())" method="get" action="processAssocDeletePermit.jsp">
                                <table width="536" border="1">
                                    ...
                                    <tr>
                                        ...
                                        <th width="205" scope="col"><div align="center">Permit Name</div></th>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div align="center">
                ...
                %>         
                        ...
                        <label><%=realPath%></label>
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <textarea name="textarea1" id="textarea1" rows="5" cols="47" disabled wrap="soft"><%=fieldSet.getString("Rules")%></textarea>
                                <p></p>
                                <div align="center">
