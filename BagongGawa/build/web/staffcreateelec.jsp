...
%>
            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    ...
                    <h3 class="side">&nbsp;</h3>
                    <p>In this part, you are allowed to create a new election.  Just fill in the election details and click 'Submit' in order to create a new election. 
                    <br> <ul>                  
                    </ul></p>            
                </div>
                ...
                <div class="contactform">
                    <form onSubmit="return(checkForm())" action="processStaffCreateElection.jsp" method="get">
                        <input type="hidden" name="maxDays" id="maxDays" value="<%=maxDays%>">
                        <fieldset>
                            <legend>&nbsp;ELECTION DETAILS&nbsp;</legend>
                            <p>
                                <label class="left" id="nameDivtag">Nomination Choice:</label> 
                                <select name="nameDiv" id="nameDiv">
                                    <option value="0">Select... </option>
<%
                            Election2 e =new Election2();
                            CachedRowSet nomElec = e.getNomTableJustClosed2();
                            CachedRowSet nomSet;
                            int id=0,prev= -1;
                            ...
                            while(nomElec.next())
                            {
                                id=nomElec.getInt("NomId");
                                nominationName=nomElec.getString("NomName");
%>
                                    <option value=<%=id%>><%=nominationName%></option>
<%
                            }    
%>                          
                                </select>
                            ...
                            <p>
                                <label class="left" id="polltag">Election Name:</label> 
