...
%>
            ...
            <div class="main-content">
                <!-- Pagetitle -->
                <h1 class="pagetitle">Manage Polls</h1>
                <h2>Update and view different polls</h2>
                <h1 class="block" align="center">Polls List</h1>
...
%>                        
                            <tr>
                                <td><div align="center"><%=p.getString("Pollname")%></div></td>
<%
                                java.util.Date startDate = p.getTimestamp("PollSDate");
                                java.util.Date closeDate = p.getTimestamp("PollCDate");
...
%>
                                ...
                                <td><div align="center"><%=p.getString("Pollstatus")%></div></td>
<%
                                if(p.getString("Pollstatus").equalsIgnoreCase("Open"))
                                {    
%>                        
                                <td><div align="center"><a href="staffeditpoll.jsp?pollid=<%=p.getInt("Pollid")%>">Edit</a> | <a href="processStaffStopPoll.jsp?Pollid=<%=p.getInt("Pollid")%>">Stop</a></div></td>
<%
                                }
                                else
                                {    
%>
                                <td><div align="center"><a href="javascript:poptastic('staffviewpoll.jsp?pollid=<%=p.getInt("Pollid")%>');">View</a></div></td>
<%
                                }
%>
                            </tr>
