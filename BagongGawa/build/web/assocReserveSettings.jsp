...
<script type="text/javascript">
    ...
    {
        document.getElementById("plpl").innerHTML="<img src=./img/ajax-loader.jsp/>";
            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    <div class="contactform">
                        <form name="resset" method="post" action="index.html">
                            <fieldset>
                                <legend>&nbsp;RESERVATION SETTINGS&nbsp;</legend>
                                <p>
                                    <label for="contact_familyname" class="left"> Amount of days residents can cancel before the reservation:</label>
                                    <input type="text" name="contact_postalcode" id="contact_postalcode" class="field" value="" tabindex="1" />
                                </p>
