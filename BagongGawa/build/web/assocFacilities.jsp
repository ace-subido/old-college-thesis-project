...
%>
                ...
                <div class="main-content">
                    ...
                    <h1 class="side"><img src="icons/facilities_icon.jpg" alt="Image description" title="Image title" />List of Facilities </h1>
                    <h3 class="side">&nbsp;</h3>
                    <p>This page contains the list of facilities of your community. You as an admin can add new facilities of your community.</p>
                    
                    <div class="contactform">
                        <center><p>To add/edit types of facility click <a href="assocCreateFacType.jsp">Facility Type</a></p><p>(eg. basketball courts, tennis courts, ballroom, church)</p></center> <br><br>
                    </div><br><br><br>
                    <%
            if (crset != null) {
                if (crset.size() == 0) {
                    ...
                    <div class="column1-unit">
                        ...
                        while (crset.next()) {
                                %>
                                <tr><td><%=crset.getString("FaciName")%></td><td><%=crset.getString("Type")%></td><td><%=divu%>&nbsp;<%=crset.getString("Location")%></td><!--<td>%=crset.getInt("Capacity")%></td><td>%=crset.getInt("LandArea")%> square meters</td><td>%=crset.getInt("UsageFee")%></td><td>%=crset.getInt("ReservationFee")%></td>--><td><a href="assocCreateFac.jsp?facility=<%=crset.getInt("FacilityId")%>">Edit Details</a></td>
                                </tr>
                            ...
                            <br />
                        <p><input type="button" onclick="window.location.href='assocCreateFac.jsp?facility=0'" name="submit" id="submit" class="button" value="Add New Facility" tabindex="6" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></form>
