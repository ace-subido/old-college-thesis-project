...
%>
                ...
                <h1 class="pagetitle">Staff : <%=ctv.getString("SGName")%> Petition Group</h1>
		<div class="column1-unit">
                    ...
                    <br>
                        <%if(ctv.getString("SGStatus").equals("Pending Petition")){
                            %>
                            <a href='processStaffApproveSocGPetition.jsp?sgid=<%=ctv.getInt("SGID")%>'>Approve Petition Group</a>
                        <%}%>
