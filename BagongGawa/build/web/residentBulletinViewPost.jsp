        ...
        <div class="header">
            ...
            <div class="header-breadcrumbs">
                <ul>
                    ...
                    <li><a href="residentBulletinCategories.jsp?cat=<%=cat%>"><%=cat%></a></li> 
                    <li><%=title%></li>
                </ul>
            </div>
        </div>
...
<% 
                        ...
                        {
                            String edit="residentBulletinEditPost.jsp?content="+ctv.getString("bulletinContent")+"&bulId="+ctv.getInt("bulletinId")+"&title="+title+"&cat="+cat;
                            String delete="residentBulletinDeletePost.jsp?bulId="+ctv.getInt("bulletinId")+"&cat="+cat;
                            if(!ctv.getString("locked").equals("Yes"))
                            {
                                if(ct.checkIfMod((String)session.getAttribute("uname"), cat))
                                {
                                    String lock="residentBulletinLock.jsp?bulId="+ctv.getInt("bulletinId")+"&title="+title+"&cat="+cat;
%>
                
                                    <input type="button" class="button2" value="Lock Thread" onClick="window.location.href='<%=lock%>'">
<%                        
                                }
%>        
                                <input type="button" class="button2" value="Delete" onClick="window.location.href='<%=delete%>'"><input type="button" class="button2" value="Edit" onClick="window.location.href='<%=edit%>'">
<%                    
                            }
                            else
                            {
...
%>
                        ...
                        <br><br><br>
                        <hr />
                        <form class="contact-form" name="comment" action="processResidentViewPost.jsp" method="get">
