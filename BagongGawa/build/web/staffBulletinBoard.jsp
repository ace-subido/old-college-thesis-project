            ...
            <div class="main-content">
                ...
                <div class="main-subcontent">
                    <div class="subcontent-unit-border-green">
                        ...
                        <p><br><a href="staffBulletinAnnouncements.jsp">Site Announcements</a></p>
                    </div>
<%            
                    if(ctv.size() >0)
                    {
%>
                        <table width="600px">
                            ...
                            <tr align="center">
                                <td colspan="2" width="100%"><b>Forums</b><br></td>
                            </tr>
<% 
                            ctv.next();
                            {
%>
                            <tr>              
                                <td style="width:400px"><a href="staffBulletinCategories.jsp?cat=<%=ctv.getString("catName")%>"><%=ctv.getString("catName")%> </a></td><td style="width:25%"><%=ct.checkBulletinBoardCat(ctv.getString("catName"))%> post(s)</td>
                                <br>
                            </tr>
<% 
                            }
...
%>
        ...
        <!-- C. FOOTER AREA -->      
        <div class="footer">
            <p>Copyright &copy; 2008 Converge | All Rights Reserved</p>
            <p class="credits">Design by GCAP | Modified by <a href="#" title="Adaptor Homepage">The Gwapings</a> | Powered by <a href="#" title="Content Management System">Meralco</a> | <a href="http://validator.w3.org/check?uri=referer" title="Validate XHTML code">W3C XHTML 1.0</a> | <a href="http://jigsaw.w3.org/css-validator/" title="Validate CSS code">W3C CSS 2.0</a></p>
        </div>      
    </div> 
</body>
</html>