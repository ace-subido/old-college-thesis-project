...
<% 
    ...
    CachedRowSet poll = p.getSpecificElec(elecid);
    poll.next();
%>  
    <!-- Main Page Container -->
                ...
                <div class="column1-unit">
                    <table width="536" border="1">
                        <tr>
                            <td>
                                <div align="center">
                                    <label for="vill_name" class="left" id="polltag">ElectionName Name:</label> 
                                </div>
                            </td>    
                            <td>
                                <div align="center">
                                    <label><%=poll.getString("ElecName")%></label>
                                </div>
                            </td>
                        </tr>    
                        <tr>
                            ...
                            <td>
                                <div align="center">    
                                    <label><%=poll.getString("ElecDesc")%></label>
                                </div>
                            </td>    
                        </tr>
<%
                                java.util.Date startDate = poll.getTimestamp("ElecSDate");
                                java.util.Date closeDate = poll.getTimestamp("ElecCDate");
...
<%
                    ...
                    CachedRowSet p2 = db.getElecChoices2(elecid);
                    ...
                    while(p2.next())
                    {
                        vote = p2.getInt("ElecResId");
                        resSet = r.getResInfo(p2.getInt("ElecResId"));
                        resSet.next();
                        
                        if(max<p2.getInt("ElecVoteNum"))
                        {
                            name = resSet.getString("FirstName")+" "+resSet.getString("LastName");
                            max = p2.getInt("ElecVoteNum");
                        }    
%>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<%=resSet.getString("FirstName")%> <%=resSet.getString("LastName")%> - <%=p2.getInt("ElecVoteNum")%>
                        <br>
<%
                    }
%>
