...
%>
                ...
                <div class="main-content">
                    ...
                    <!-- Pagetitle -->
                    <h1 class="pagetitle">Bulletin Board Settings</h1>
                    ...
                    <div class="column1-unit">
                        ...
                        <div class="contactform">
                                ...
                                <form name ="lot">
                                 <fieldset>
                                <p>List of Bulletin Board Categories:</p>
                                <div class="column1-unit" id="listCat" name="listCat">
                                   
                                </div>
                                <p>New Category Name:
                                  <input type="text" name="newCat" id="newCat" />
                                  <input type="button" name="Add Category" id="Add Category" value="Add Category" onclick='addCategories()' />
                                </p>
