...
<% 
    ...
    poll.next();
    CachedRowSet pollSet = po.getMaxDays();
    pollSet.next();
    int maxDays = pollSet.getInt("nomdays");
...
%>
            ...
            <div class="main-content">
                ...
                <div class="contactform">
                    <form name ="login" onSubmit="return(checkForm())" action="processStaffEditNom.jsp" method="get">
                        ...
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="text" name="pollname" id="pollname" class="field" value="<%=poll.getString("NomName")%>">
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <textarea name="textarea1" id="textarea1" rows="5" cols="47" onfocus="" wrap="soft"><%=poll.getString("NomDesc")%></textarea>
                            </p>
                            <p>
                            ...
                            <input type="hidden" id="hidid" name="hidid" value="<%=request.getParameter("nomid")%>"/>
                        </fieldset>
