...
<%
                ...
                java.util.Date yey1 = (java.util.Date)session.getAttribute("WBPrdStart");         
                java.util.Date yey2 = (java.util.Date)session.getAttribute("WBPrdEnd");
                java.util.Date yey3 = (java.util.Date)session.getAttribute("WBPrdEq");
                String ggg = "";
                if(yey3 != null)
                {
                ...
                int days = (Integer)session.getAttribute("DAYSZZ2");    
%>
                <!-- Pagetitle -->
		...
		<div class="column1-unit">
                    ...
                    <p>This is the interface for the association dues billing management of the community. The generation of association dues will automatically be set by the system and will be automatically issued on the cut-off date in the current billing period.
                    <br>
                    <p align="right"><a href="staffBill.jsp">Back to Billing Management Main Page</a><br></p>
                </div> 
                   <hr class="clear-contentunit"/>
                    <div class="column2-unit-left">
                         <h1 class="block">Current Billing Period </h1>
<%
                        if(days==0)
                        {
%>
                            <p> <br> Today is the cut-off for the billing period : <br><br><%=ppp%> <br> to <br><%=lll%><br>
                            <br>Next Billing Period : <%=lll%><br> to <br> <%=ggg%></p>
<%
                        }
                        else
                        {
...
%>        
                    ...
                    <div class="column2-unit-right">
                        <h1 class="block">Bill Management </h1>
                        <p><br> <a href="staffGenWaterBill.jsp">Generate Water Bill Batch</a><br>
                        <a href="staffBillInputW.jsp">Input Meter Readings</a><br>                               
                        <a href="staffBillClearW.jsp">Resident Bill Clearance</a><br>                               
                        <a href="staffBillReportW.jsp">Bill Reports</a><br><br></p>
                    </div>
            </div>
        </div>
        <!-- C. FOOTER AREA -->      
