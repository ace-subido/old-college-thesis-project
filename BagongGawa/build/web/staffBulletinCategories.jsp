...
<%
    ...
    CachedRowSet ctv = ct.getBulletinPosts(cat);
    ...
    <div class="page-container">
        ...
        <div class="header">
            ...
            <div class="header-breadcrumbs">
                <ul>
                    <li><a href="staffDash.jsp.jsp">Tahanan Village</a></li>  
            ...
            <div class="main-content">
                ...
                <div class="main-subcontent">
                    <div class="column2-unit-left">
                        <form name="form1" id="form1" method="GET" action="staffAddMod.jsp" >
                            <h1>Search for Username</h1>
                            <p>You can search for a username and promote it as a moderator for this Category</p>
                            <br>
                            <input type="hidden" id="cate" name="cate" value="<%=cat%>">
                            <p><input type="text" id="text1" name="text1" onkeyup="getAllResidents(this.value)"> &nbsp;<input type="submit" value="Add Moderator"></p>
                            <p>Results:</p>
                            <br><div id="modList" name="modList"></div>
                        </form>
                    </div>
                    <div class="column2-unit-right">
                        <h1>List of Moderators for this Category</h1>
                        <div id="list1"></div>
                    </div>
                    <br><br>
                    <hr />
                    <table width="600px">
                        <tr bgcolor="EDEEF0">
                            <th colspan="2"><h1 align="center"><%=cat%></h1></th>
                        </tr>
                        <tr align="center">
                            <td width="75%"><b>Posts</b><br></td>
                            <td width="25%"><b>Replies</b></td>
                        </tr>
<% 
                        if(ctv.size()>0)
                        {
                            ctv.next();
                            {
                                CachedRowSet cr = ct.getBulletinComments(ctv.getInt("bulletinId"));
                                int size = cr.size();
%>
                        <tr>              
                            <td width="75%"><a href="staffBulletinViewPost.jsp?title=<%=ctv.getString("bulletinTitle")%>&cat=<%=cat%>"><%=ctv.getString("bulletinTitle")%> </a></td>
                            <td width="25%"><%=size%></td>
                            <br>
                        </tr>
<% 
