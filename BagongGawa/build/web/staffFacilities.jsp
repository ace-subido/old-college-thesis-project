        ...
        <div class="nav2">
          ...
          <ul>
            <li><a href="#">Manage Association</a><!--<![endif]-->
              <!--[if lte IE 6]><table><tr><td><![endif]-->
                <ul>
                  <li><a href="assocDirectorMain.html">View Directors or Officers</a></li>
                  <li><a href="assocFacilities.html">View/Edit Facilities</a></li>
                  <li><a href="assocRuleFees.html">View Rules & Regulations</a></li>
                  <li><a href="assocVillInfo.html">View/Edit Village information</a></li>
                  <li><a href="assocServices.html">Association Services</a></li> 
          ...
          <ul>
            <li><a href="#">Manage Residents<!--[if IE 7]><!--></a><!--<![endif]-->
              <!--[if lte IE 6]><table><tr><td><![endif]-->
                <ul>
                  <li><a href="header2.html">Add/View Social Groups</a></li>
                  <li><a href="header2.html">Add/View Residents</a></li>
                  <li><a href="header2.html">View Complaints and Suggestions</a></li>
                  <li><a href="header2.html">Payment Tracking</a></li>
   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Facilities List</h1>

        <!-- Content unit - One column -->
        <!-- Content unit - One column -->
        <h1 class="block">Facilities Details</h1>
        <div class="column1-unit">
          ...
          <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Sort By:  
            <select name="contact_title" id="contact_title" class="combo">
              ...
              <option value="Type">Facilities Type</option>
          ...
          <table>
            <tr>
              <th class="top" scope="col">FACILITIES NAME</th>
            <th class="top" scope="col">FACILITIES TYPE</th>
