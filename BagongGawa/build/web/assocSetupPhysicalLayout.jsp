...
%>
      ...
      <div class="main-content">
        <h1 class="pagetitle">Setting up your Community's physical layout &nbsp; </h1>
        ...
        <div class="column1-unit">
            <div class="contactform">
                <center>
                    <p><h2>Does your community have a master list of the physical layout?</h2><br>
                        (e.g. for Villages, a set of phases, blocks and lots are already setup in excel)
                        
                        </p><br><br>
                        <p>
                            <input type="button" value="Yes" onclick="window.location.href='assocUpload.jsp'"><input type="button" value="No" onclick="window.location.href='assocSetupPhysical1.jsp'">
                        </p>
                </center>
