...
%>
            ...
            <div class="main-content">
                <!-- Pagetitle -->
                <h1 class="pagetitle">Setup Residents</h1>
                <div class="column1-unit">
                    <p>
                        <font color="red">Only .xls file format are accepted.</font>
                        <div align="left"><p>A format should be strictly followed. <br>
                            1st column should be the First name<br>
                            2nd column should be the Last name.<br>
                            3rd column should be email address<br>
                            4th column should be Phone number.<br>
                            5th column should be sex/gender.<br>
                          
                            6th column should be which block/floor the lot belongs to.<br>
                            7th column should be which phase/building the lot belongs to.<br>
                            8th column should be the lot number.<br>
                            9th column should be whether the person is a "Eesident" or "Director"<br>
                            4th column should be which phase/building the lot belongs to.<br>
                            
                            </div>
                    </p>
                    <form action="processAssocUpload2.jsp">
                        <input type="file" id="uploadfile" name="uploadfile" value="">
                        <br><br><hr /><br><br>    
                        <input type=submit value="Submit" class="button2">  <input type="button" value="<< Back" onclick="window.location.href='assocSetupResidents.jsp'" class="button2">   
                    </form>
                </div>
            </div>
        </div>
