...
<%
    ...
    while(vilinfo.next())
    {
        totalDivision = vilinfo.getInt("Division");
        vType= vilinfo.getString("DivisionUnit");
    }
...
%>
            ...
            <div class="main-content">
                ...
                <h1 class="block">Manage the  physical layout of your community</h1>
                ...
                <div class="contactform">
                    <fieldset>
                        <p>
                            ...
                            {
                            %>
                            <label class="left"><b>Phase</b></label>
                        <%
                            }else
                                {
                            %>
                            <label class="left"><b>Building</b></label>
                            <%
                            }
                            %>
                            <select name="phbl">
                              ...
                              <%
                                    ...
                                    int nCtr=1;
                                    while(nCtr <= totalDivision)
                                    {
                                      %>
                                      <option value="<%=nCtr%>" onclick='getBlFl3(<%=nCtr%>)'><%=nCtr%></option>
                            <%
                                      nCtr++;
                                    }
                              %>
