...
%>
            ...
            <!-- Pagetitle -->
            <h1 class="pagetitle">Newsletter Service</h1>
                <div class="column1-unit">
                    <h1 class="side"><img src="icons/reservation-icon.jpg" alt="Image description" title="Image title" />View Newsletter</h1>
                    <h3 class="side">&nbsp;</h3>
                ...
                <div class="column1-unit">
                  <div class="main-content">
					...
					CachedRowSet crs = news.viewARNewsletters();
					while(crs.next()){
						String author = crs.getString("author");
						String subject = crs.getString("subject");
						String status = crs.getString("nlstatus");
			%>
                      <tr>
                        <td><%=author%></td>
                        <td><a href="viewNewsletter.jsp?parameter=<%=subject%>"><%=subject%></a></td>
                        <td><%=status%></td>
                      </tr>
                      <%}
				crs.close();
