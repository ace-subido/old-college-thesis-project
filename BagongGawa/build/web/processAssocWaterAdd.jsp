...
<html>
    ...
    <body>
        ...
        <% 
        String a = request.getParameter("bhiz44");
        double ab = Double.parseDouble(request.getParameter("bhiz33"));
        String c = request.getParameter("bhiz22");
        ...
        <script type= "text/javascript">
			<!--
				...
				alert("Water Fee Type has been added!");
