...
<!--[if IE]><style type="text/css"> body {word-wrap: break-word;}</style><![endif]-->
    ...
    <body>
        ...
        <%
            ...
            int adv = Integer.parseInt(request.getParameter("facility"));
            ...
            if (crset.size() == 0) {
                ...
                <div class="column1-unit">
                    ...
                    <div class="contactform">
                        <form name ="login" onSubmit="return(checkForm())" action="processAssocSetupPart2a.jsp" method="get">
                            <fieldset>
                    ...
                    if (v.size() > 0) {
                        ...
                        for (int i = 0; i < v.size(); i++) {
                            s = v.get(i);
                                ...
                                <p><label for="vill_name" class="left">Allow Reservations:</label> 
                                ...
                                <br /><p><label for="vill_name" class="left">Capacity (no. of persons):</label> 
                                <input type="text" name="c" id="asso_name" class="field" value=""></p>
                                <br /><p><label for="vill_name" class="left">Land Area / Size (square meter):</label> 
                                <input type="text" name="a" id="asso_name" class="field" value=""></p>
                                <br /><p><label for="vill_name" class="left">Reservation fee</label> 
                                <input type="text" name="rf" id="asso_name" class="field" value=""></p>
                                <br />
                                
                                <p><input type="submit" name="submit" id="submit" class="button2" value="Submit"> <input type="button" class="button2" value="<< Back" onclick="window.location.href='assocSetupPart2.jsp'"></p>
                    ...
                    <hr class="clear-contentunit" />
                    <div class="column1-unit">
                        <a href="assocCreateField.jsp">Customize fields in this form</a>
                        
                        <div class="contactform">
                            <form name="login2" onSubmit="return(checkForm2())" action="processAssocSetupPart2a.jsp" method="get">
                                <fieldset>
                                    <legend>&nbsp;FACILITY DETAILS&nbsp;</legend>
                                    ...
                                    <input type="text" name="n" id="asso_name" class="field" value="<%=crset.getString("FaciName")%>"></p>
                                    <br />
                                    <p>
                            ...
                            if (v.size() > 0) {
                                ...
                                for (int i = 0; i < v.size(); i++) {
                                    ...
                                    <br />
                                    <p><label class="left">Availability</label>
                            ...
                            if (crset.getString("Availability").equals("unavailable")) {
                                ...
                                <p class="right"><a href="assocCreateFacType.jsp">Add Facility Type</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></fieldset><fieldset>
                            ...
                            if (crset.getString("AllowRes").equals("No")) 
                                    ...
                                    <p>&nbsp;&nbsp;&nbsp;<a href="assocFacReserveSettings2.jsp?tit=<%=adv%>">Advanced reservation settings</a></p>
                                    <br />
