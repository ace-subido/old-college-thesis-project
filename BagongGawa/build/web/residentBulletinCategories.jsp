        ...
        <!-- B.1 MAIN CONTENT -->
            <div class="main-content">
                ...
                <div class="main-subcontent">
                    <input type="button" class="button2" value="Start new Thread" onClick="window.location.href='residentBulletinPost.jsp?cat=<%=cat%>'"><br><br>
                    <table width="600px">
                        <tr bgcolor="EDEEF0">
...
%>
                        <tr>              
                            <td width="75%"><a href="residentBulletinViewPost.jsp?title=<%=ctv.getString("bulletinTitle")%>&cat=<%=cat%>"><%=ctv.getString("bulletinTitle")%> </a></td>
                            <td width="25%"><%=size%></td>
                            <br>
                        </tr>
<% 
...
%>
                        ...
                        <div class="subcontent-unit-border-blue">
                            ...
                            <br><a href="residentBulletinPost.jsp?cat=<%=cat%>">Start new thread</a></p>
                        </div>
<%
                    }
%>
