...
%>    
            ...
            <div id="board">
                <div align="center">&nbsp; &nbsp;&nbsp;<h2><font color="#666633">Edit Comment</font></h2><br></div>
                <div align="center" id="alertLoc"></div>
                <div align="center" id="alertName"></div>     
                <div align="center">
                    <br><br>
                    <form name="test" action="processResidentBulletinEditComment.jsp" method="get" onSubmit="return(checkCat())">
                        ...
                        <div class="main-content">  
                            <div class="column1-unit">
                                <input type="button" class="button2" value="Cancel" onClick="window.location.href='residentBulletinViewPost.jsp?title=<%=title%>&cat=<%=cat%>'"><input class="button2" type="submit" value="Save Changes">&nbsp;
                            </div>
                        </div>
                    </form>
                </div>
