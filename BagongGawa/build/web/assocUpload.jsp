                ...
                <div class="column1-unit">
                    <p>
                        ...
                        <div align="left"><p>A format should be strictly followed. <br>
                            1st column should be the size of a lotarea. (numbers only)<br>
                            2nd column should be the vacancy of the lot, whether it is "unoccupied" or "occupied".<br>
                            3rd column should be which block/floor the lot belongs to.<br>
                            4th column should be which phase/building the lot belongs to.<br>
                            5th column should be the lot number.<br>
                            </div>
                    </p>
                    
                    <form action="processAssocUpload.jsp">
                        <input type="file" id="uploadfile" name="uploadfile" value="">
                   <br><br><hr /><br><br>
                    <input class="button2" type=submit value="Submit"> 
                    <input type="button" onClick="window.location.href='assocSetupPhysicalLayout.jsp'" name="submit" id="submit" class="button2" value="<< Back" tabindex="6" />
                     </form>
                </div>
