...
<html>
    ...
    <body>
        ...
        sg.rejectMemberApplicant(a, b);
                
        Ace face = new Ace();
        String lp = "Your application for membership has been rejected. You have been rejected as a member of the "+ctv2.getString("SGName")+" group.";
        String f = "["+ctv2.getString("SGName")+"] Social Group Membership Rejected";
