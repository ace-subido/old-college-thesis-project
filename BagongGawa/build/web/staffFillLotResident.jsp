...
%>
            ...
            <div class="main-content">
                ...
                <!-- Pagetitle -->
                <h1 class="pagetitle">Physical Layout</h1>
                <h1 class="block">Search for a resident to fill this unit/lot</h1>
                <hr class="clear-contentunit" />        
                <div class="contactform">
                    <fieldset>
                       <input type=hidden id="phbl" name="phbl" value="<%=phbl%>">
                       <input type=hidden id="blfl" name="blfl" value="<%=blfl%>">
                       <input type=hidden id="lotnum" name="lotnum" value="<%=lotnum%>">
                       <legend>
                           <%
                            if(vType.equals("phase"))
                            {
                           %>
                                Phase <%=phbl%> Block <%=blfl%> Lot <%=lotnum%>
                           <%
                            }
                            else
                            {
                           %>
                                Building <%=phbl%> Floor <%=blfl%> Unit <%=lotnum%>
                           <%
                            }
                           %>
                      ...
                      <p><label class="left">Resident Name: </label> <input type="text" id="name" onkeyup="getAllResidents4(this.value)"></p>
