...
%>
            ...
            <h1 class="pagetitle">Newsletter Service</h1>
                ...
                <div class="column1-unit">
                  <div class="main-content">
                    <form action="newsletterStaffSubmit.jsp" method="get" id="letter" onsubmit="return(checkForm())">
                      <table>
                        <tr>
                          <td>Subject: </td>
                          <td><input type="text" width="400" name="subjectHead" /></td>
                        </tr>
                        <tr>
                          <td colspan="2" valign="top"><textarea name="content" cols="10" style=" width:475px; height:300px"></textarea>
                          </td>
                        </tr>
                        <tr>
