...
<%
    ...
    CachedRowSet allPermitResident = p.getAllPermitResident();
    ...
    while(allPermitResident.next())
    {
        java.util.Date expDate = allPermitResident.getTimestamp("years");
        ...
        if(year<year2)
            p.updateExpiration(allPermitResident.getInt("pID"));
        else
        {    
            if(month<month2)
                p.updateExpiration(allPermitResident.getInt("pID"));
...
%>  
            <h1 class="block">Bulletin Board</h1>    
