...
<%	
    ...
    int resPermitId = Integer.parseInt(request.getParameter("resPermitID"));
    CachedRowSet resPermitDetail = p.getResidentPermitDetail(request.getParameter("resPermitID"));
    resPermitDetail.next();
    String permitID = String.valueOf(resPermitDetail.getInt("permitID"));
    CachedRowSet NoSet = p.getNo(Integer.parseInt(permitID));
    if(NoSet.size()<=0)
    {    
        ...
        CachedRowSet residentDB = r.getResInfo(resPermitDetail.getInt("resId"));
        residentDB.next();
        checkSet.next();
        ...
        <!-- B. MAIN -->
            ...
            <div class="main-content">
                <div class="column1-unit">
                    ...
                    <form onsubmit="return (checkForm())" action ="processResUpdatePermit.jsp" method="get">
                        <table width="536" border="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div align="center">
                                         <label><b><%=resPermitId%></b></label>
                                    </div>            
                                </td>
                            </tr>
                            <input type="hidden" id="hiddenRID" name="hiddenRID" class="field" value="<%=resPermitId%>"></input>
                            <div>
                                <label for="n" id="rulestag" class="left" style="font-size:10pt"><b>Rules</b></label> 
                            </div>            
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <textarea name="textarea1" id="textarea1" rows="5" cols="47" readonly><%=fieldSet.getString("Rules")%></textarea>
                            <p></p>
                        ...
                        %>
                            <tr>
                                ...
                                <td>
                                    <div align="center">
                                         <label name="pfee" id="pfee"><%=fieldSet.getDouble("renewfee")%></label>
                                    </div>            
                                </td>
                            </tr>
                        <%
                        ...
                        <div align="center">
                            ...
                            <input type="submit" value="Submit for Renew"></input>
...
%>
            <p>
            <div align="center">
                <h1>Permit has already been disabled</h1>
            </div>
            </p>
<%
        }
