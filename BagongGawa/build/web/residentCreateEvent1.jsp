...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            var fd = document.tr.ctr;
            var dd = document.tr.ctr2;
            ...
            if(dd.value == "")
            {
                alert("Please put in a rough estimate");
                return(false);
            }
            return (true);
        }
...
%>    
            ...
            <div class="main-content">
                <!-- Pagetitle -->
                <h1 class="pagetitle">Events Approval Service</h1>
		<div class="column1-unit">
                    <h1 class="side"><img src="icons/events-icon.jpg" alt="Image description" title="Image title" />Create an Event</h1>
                    <h3 class="side">&nbsp;</h3>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostruderci tation ull consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore. </p>
                    <ul>
                        <li> <a href="residentEvents.jsp">Back to Events Service</a></li>                  
                    </ul>
                </div>     
                <hr class="clear-contentunit" />
                <div class="column1-unit">
                    <div class="contactform">
                        <form name="tr" onSubmit="return(checkchoose())" action="processResidentCreateEvent1.jsp" method="get">
                            <fieldset>
                                <legend>&nbsp;CREATING AN EVENT&nbsp;</legend>
                                <p>&nbsp;&nbsp; <center><p>Are you going to use a facility?</p></center>
                                <p><center>
                                    <select name="ctr" id="ctr" class="combo">
                                        <option value="choose"> Select... </option>
                                        <option value="YES"> YES </option>
                                        <option value="NO"> NO </option>
                                    </select><br>       </center>    
                                    <br><br>
                                    <center><p>Rough Estimate of Visitors?</p></center>
                                    <center> <input type="" name="ctr2" id="ctr2" class="field"/> </center><br><br>
                                <p><input type="submit" name="submit" id="submit" class="button2" value="Next" tabindex="6" /></p>
                            </fieldset>
                        </form>                
                    </div>
                </div>
