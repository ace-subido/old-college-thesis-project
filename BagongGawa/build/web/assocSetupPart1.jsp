...
<script type="text/javascript">
    ...
    function checkForm()
    {
       var i = 0;
        ...
        if(document.getElementById('villunit').value == 0)
        {    
            document.getElementById('villunittag').style.color = "red";
            i++;
        }
        else
            document.getElementById('villunittag').style.color = "black";
    ...
    { 
        var i = 0;
        if(document.getElementById('dv').value == 0)
        {    
            document.getElementById('dvtag').style.color = "red";
            i++;
        }
        else
...
%>
            ...
            <!-- Pagetitle -->
                ...
                <div class="column1-unit">
                    <h1 class="side">Community Information &nbsp;</h1>
                    <h3 class="side">&nbsp;</h3>
                    <p>This section is divided into (2) two parts:</p>
                    <ul>
                        <li> Adding information about your community</li>
                        <li> Adding different community divisions of your community (e.g <b>Beautification</b>, <b>Security</b>)</li>
                    </ul>
                    <br>
...
%>
                        <form name="vinfo" onSubmit="return(checkForm())" action="processAssocVillInfo2.jsp" method="get">
                            ...
                            <fieldset>
                                ...
                                <p>
                                    <label class="left" id="villunittag">Type of Community:</label>
                                    <select name="villunit" id="villunit" class="combo">
                                        <option value="0"> Select... </option>
                                        <option value="building"> Condominium </option>
                                        <option value="phase"> Subdivision/Village </option>
                                    </select>
                                </p>
                                <p><input type="submit" name="submit" id="submit" class="button2" value="Submit" tabindex="6"/></p>
                            </fieldset>
                        </form>
<%
                        }
%>
                    ...
                    <div>
                        <form name="form1" onSubmit="return(checkForm3())" method="post" action="proccessAssocCreateComManDiv2.jsp">
                            <fieldset>
                                <legend>Add New Community Management Division</legend>
                                <ul>    
<%
                                if(ctv.size() > 0)                        
                                {
...
%>
                                ...
                                <p>
                                    <label class="left" id="dvtag">Division Name:</label>
                                    <input name="dv" id="dv" class="field" value=""/>
                                </p>
                                <p><input type="submit" class="button2" value="Add New Division"/> </p>
                            </fieldset>
                        </form>
                    </div> 
                    <p>&nbsp; </p>
