...
<%
    ...
    CachedRowSet pset = p.getTemplateDetails(id);
Unit u = new Unit();
                ...
                <div class="column1-unit">
                    ...
                    <form name="addpermit" onSubmit="return (checkForm())" action ="processAssocAddPermit.jsp" method="get">
                        <div align="center">
                            ...
                            <input type="text" id="name" name="name" class="field" value="<%=pset.getString("PermitName")%>"></input>
                        </div>
                        ...
                        %>    
                            <tr>
                                <td>
                                    <div align="center">
                                        <input name="check2" type="checkbox" id=check2 disabled="true" checked = "true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field")%>'></input>
                                        <input type="hidden" id="field2" name="field2" class="field" value='<%=pset.getString("field")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                            ...
                            <tr>
                                <td>
                                    <div align="center">
                                        ...
                                        <input name="check3" type="hidden" id="check3" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field2")%>'></input>
                                        <input type="hidden" id="field3" name="field3" class="field" value='<%=pset.getString("field2")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>                          
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check4" type="hidden" id="check4" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field3")%>'></input>
                                        <input type="hidden" id="field4" name="field4" class="field" value='<%=pset.getString("field3")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check5" type="hidden" id="check5" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field4")%>'></input>
                                        <input type="hidden" id="field5" name="field5" class="field" value='<%=pset.getString("field4")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check6" type="hidden" id="check6" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field5")%>'></input>
                                        <input type="hidden" id="field6" name="field6" class="field" value='<%=pset.getString("field5")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check7" type="hidden" id="check7" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field6")%>'></input>
                                        <input type="hidden" id="field7" name="field7" class="field" value='<%=pset.getString("field6")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check8" type="hidden" id="check8" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field7")%>'></input>
                                        <input type="hidden" id="field8" name="field8" class="field" value='<%=pset.getString("field7")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check9" type="hidden" id="check9" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field8")%>'></input>
                                        <input type="hidden" id="field9" name="field9" class="field" value='<%=pset.getString("field8")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check10" type="hidden" id="check10" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field9")%>'></input>
                                        <input type="hidden" id="field10" name="field10" class="field" value='<%=pset.getString("field9")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check11" type="hidden" id="check11" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field10")%>'></input>
                                        <input type="hidden" id="field11" name="field11" class="field" value='<%=pset.getString("field10")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check12" type="hidden" id="check12" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field11")%>'></input>
                                        <input type="hidden" id="field12" name="field12" class="field" value='<%=pset.getString("field11")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check13" type="hidden" id="check13" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field12")%>'></input>
                                        <input type="hidden" id="field13" name="field13" class="field" value='<%=pset.getString("field12")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
                        ...
                        %>  
                            <tr>
                                <td>
                                    <div align="center">
                                        <input type="checkbox" checked="true" disabled="true"/>
                                        <input name="check14" type="hidden" id="check14" checked="true"/>
                                     </div>
                                </td>
                                <td>
                                    <div align="center">
                                        <input type="text" class="field" disabled="true" value='<%=pset.getString("field13")%>'></input>
                                        <input type="hidden" id="field14" name="field14" class="field" value='<%=pset.getString("field13")%>'></input>
                                    </div>
                                </td>    
                            </tr>
                        <%
