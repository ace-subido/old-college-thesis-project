       ...
       <h1 class="block">Resident Bills</h1>
        ...
        <div class="column1-unit">
          ...
          <%
            ...
            if(tempy2.size()>0){%>
          <center><h2>Miscallenous Dues for the Billing Period of</p><br><%=ppp%> to <%=lll%></h2><table>
               <tr><th>Charge Name</th><th>Amount</th>
               <%    while(tempy2.next()){
                   ...
                   if(ewan.compareTo(yey1) > 0 && ewan.compareTo(yey2) < 0){ 
                       if(tempy2.getString("type").equals("Misc Com")){%>
                           </tr><tr><td> <%=tempy2.getString("dueName")%></td><td>P <%=tempy2.getDouble("feeamt")%> (Community Fee)</td>  
                     <%  }
                       else{%>
                            </tr><tr><td> <%=tempy2.getString("dueName")%></td><td>P <%=tempy2.getDouble("feeamt")%> (Per Resident)</td> 
                    <%   }
                    }
                   }  %>  
            </tr></table></center>
