    ...
    Billing b = new Billing();
       ...
       <h1 class="block">Resident Bills</h1>
        ...
        int a = (Integer)session.getAttribute("residentId");
         CachedRowSet cr = b.getAllBillsOFRESID(a); 
       double mom =0.00;
        %>
        <br>  
        <div class="column1-unit">
     <%if(cr.size()>0){
            ...
            %>          
            <center><p><h2>Bills of <%=(String)session.getAttribute("FirstName")%> <%=(String)session.getAttribute("LasttName")%></h2></p></center>
            <center><table>
                                <tr>
                                        <th width="15">Bill#</th>
                                ...
                                <tr>
                                    ...
                                    <td class="td2"><%=cr.getString("status")%></td>                                    
