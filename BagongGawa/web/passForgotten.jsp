    ...
    <div class="page-container">
        ...
        <div class="header">
            ...
            <div class="header-middle">    
                ...
                <div class="sitemessage">
                    ...
                    <h3>Create one for your community here...</h3>
                </div>        
            </div>
        </div>
        <br><br>
        ...
        <div class="main">
            <div class="main-navigation">
                ...
                <h1>Get Password</h1>
                <div class="loginform">
                    <form name = "login" onSubmit="return(checkForm())" action="passFor.jsp" method="get"> 
                        <p><input type="hidden" name="rememberme" value="0" /></p>
                        <fieldset>
                            <p><label for="username_1" class="top">Enter your Username</label><br />
                            <input type="text" name="n" id="username_1" class="field" value="" /></p>
                            <p><input type="submit" name="cmdweblogin" class="button" value="Submit"  /></p><Br>
                            <br>
                            <hr />
                            <br>
                            <p><label for="password_1" class="top">Not yet a member? <a href="registerPage.html">Click Here</a></label><br />
                        </fieldset>
                    </form>
                </div>
            </div>
            ...
            <div class="main-content">    
                ...
                <br>
                    <p align="justify">Being the first generic community association portal, <strong>Converge</strong> promotes
                        community empowerment through its online community association solutions. 
                        It is the new I.T. solution for community associations here in Metro Manila.
