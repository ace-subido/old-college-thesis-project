...
%>
            ...
            <div class="main-content">
                ...
                <p>Here are the list of residents that you can apply a permit for.  Just use the search function in order to look for a specific resident and click Apply Permit to apply a permit for them.</p>
                ...
                <div class="column1-unit">
                    ...
                    %>
                            <table width="636">
                                <tr>
                                    ...
                                    <th width="200" class="top" scope="col"><div align="center">Email Address</div></th>
                    ...
                    <%
                            ...
                            while(resSet.next())
                            {
                                if(resSet.getString("UserType").equalsIgnoreCase("Resident"))
                                {    
                    %>
