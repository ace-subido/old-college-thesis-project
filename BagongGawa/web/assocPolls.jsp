...
%>
        ...
        <!-- Content unit - One column -->
            ...
            <div class="column1-unit">
                ...
                <h3 class="side">&nbsp;</h3>
                <center><p>Welcome! Here you can configure the settings for the polls and election service.  Make sure to click 'Save' after editing.</p></center>
...
%>
                <form name="form1" onSubmit="return(checkForm())" method="get" action="processAssocPolls.jsp">
                    ...
                    <input type="hidden" name="hiddenstat" value="new">
                    <h1>Polls</h1>
                    <p>
...
%>
                ...
                <p><input type="submit" class="button2" value="Save"/></p>
                </form>
<%
                }
                else
...
%>
                    <form name="form1" onSubmit="return(checkForm())" method="get" action="processAssocPolls.jsp">
                        ...
                        <input type="hidden" name="hiddenstat" value="old">
                        <h1>Polls</h1>
                        <p>
                            <label class="left" name="pollstag" id="pollstag">Maximum number of days a poll can last</label>
...
<%
                        ...
                        {
%>
                            <h1>Director will Serve in <%=cr.getInt("years")%> year/s</h1>
