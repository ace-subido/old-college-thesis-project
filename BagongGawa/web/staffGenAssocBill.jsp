...
%>
       ...
       CachedRowSet ss = b.getAllAssUnIssuedBatch();
              ...
              <br><br>         
                   ...
                   <hr class="clear-contentunit"/>
                    ...
                    <div class="contactform">
                       ...
                       <form name="ass" onSubmit="return(checky())" action="processStaffGenAssocBill.jsp" method="get">
                           <fieldset><legend>Generation Bill Batch</legend>
                            ...
                            &nbsp;&nbsp;<select name='katsz4' onchange="showAssocBillBatch(this.value)" id='katsz4' class='combo'>                                 
