...
%>
                ...
                <h1 class="pagetitle"><%=ctv.getString("SGName")%> : Group Announcements</h1>
		<div class="column1-unit">
                    <h1 class="side"><img src="icons/Lui-tler.jpg" alt="Image description" title="Image title" /></h1>
                    <pThis is the announcement board for the Social Group. Only Administrators can post announcements for the group.
                    <br><br>
