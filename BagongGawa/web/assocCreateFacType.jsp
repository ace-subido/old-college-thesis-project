...
%>
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Community Facilities : Add Facility Type</h1>

        <!-- Content unit - One column -->
        <div class="contactform">
             <p>You can add the kinds of facilities that are available in your community.<br>
             (eg. basketball courts, tennis courts, ballroom, church)</p>
         </div>
        <div class="column1-unit">
					...
					%>
						<li><%=crset.getString("TypeName")%> &nbsp;<a href="assocDelFacType.jsp?id=<%=crset.getString("TypeName")%>">Edit </a> &nbsp; 					
						<%=tempytempy%></li>
       ...
       <div class="contactform">
            <form name ="tae" onSubmit="return(boob())"method="get" action="processAssocCreateFacType.jsp">
              <fieldset>
              ...
              <legend>&nbsp;ADD FACILITY TYPE&nbsp;</legend>
                ...
                <input type="text" name="name" id="asso_name" class="field" value="" tabindex="1" /></p>
                   <br />
                   <p><input type="submit" name="submit" id="submit" class="button2" value="Add" tabindex="6" /> <input type="button" onClick="window.location.href='assocFacilities.jsp'" name="submit" id="submit" class="button2" value="Back" tabindex="6" /></p>
