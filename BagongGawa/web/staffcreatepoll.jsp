...
function checkForm()
{
    ...
    if(document.getElementById('checkInput').value.length == 0)
    {    
        document.getElementById('choicestag').style.color = "red";
        i++;
    }
    else
        document.getElementById('choicestag').style.color = "black";    
...
function checkPollChoices()
{
    ...
    if(document.getElementById('pollchoice').value.length == 0)
    {    
        document.getElementById('choicestag').style.color = "red";
        i++;
    }
    ...
    {
        addPollChoice();
        document.getElementById('pollchoice').value = "";
...
%>
            ...
            <div class="main-content">
                ...
                <!-- Pagetitle -->
                <h1 class="pagetitle">Community Polls</h1>
                <div class="column1-unit">
                    <h1 class="side"><img src="icons/reservation-icon.jpg" alt="Image description" title="Image title" />Create Poll</h1>
                    <h3 class="side">&nbsp;</h3>
                    <p>In this part, you are allowed to create a poll.  Just fill in the poll details and click 'Add Poll' in order to create a new poll. 
                    <br> <ul>                  
                    </ul></p>            
                </div>
                ...
                <div class="contactform">
                    <form onSubmit="return(checkForm())" action="processStaffCreatePoll.jsp" method="get">
                        <input type="hidden" name="maxDays" id="maxDays" value="<%=maxDays%>">
                        <fieldset>
                            <legend>&nbsp;POLL DETAILS&nbsp;</legend>
                            <p>
                                <label class="left" id="polltag">Poll Name:</label> 
                            ...
                            <p>
                                <label class="left" name="pollphasetag" id="pollphasetag">Phase who can vote for polls</label>
                                <select name="pollphase" id="pollphase">
...
%>                                    
                            ...
                            <p>
                                <label for="contact_title" class="left" id="datetag">Date of Poll Closing:</label>  
                            ...
                            <p> 
                                ...
                                <input type="text" name="pollchoice" id="pollchoice" />
                                <input type="button" name="Add Poll Choice" id="Add Poll Choice" value="Add Poll Choice" onclick='checkPollChoices()' />
                            </p>
                            <input type="hidden" id="checkInput" value="">
                            <br/>    
                        </fieldset>
                        <input type="submit" name="Submit" class="button2" value="Add Poll"/>
                    </form>
