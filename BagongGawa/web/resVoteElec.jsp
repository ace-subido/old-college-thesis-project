...
<%
                ...
                int b = Integer.parseInt(request.getParameter("Elecid"));
       
                Election2 crset = new Election2();
                CachedRowSet x = crset.getSpecificElec(b);
                x.next();
                CachedRowSet p2 = crset.getElecChoices2(b);
...
%>
		...
		<div class="column1-unit">
                    ...
                    <h3 class="side">&nbsp;</h3>
                    <p>Here are the current election available to your community.  Kindly read the election detail and vote by selecting a candidate and clicking 'Vote' after you select. </p>
                </div>
                <hr class="clear-contentunit" />
                <div class="column1-unit">
                    <form name="form1" method="post" action="processResVoteElec.jsp">  
                        <h1><b><%=x.getString("ElecName")%></b></h1>
...
<%
                        ...
                        {
%>              
                            <h1><font color="#FF0000">You have already voted for this election</font></h1>
...
%>              
                            ...
                            <textarea name="textarea1" id="textarea1" rows="5" cols="47" readonly><%=x.getString("ElecDesc")%></textarea>
                            <p></p>
                            <p>
...
<% 
                            ...
                            while(p2.next())
                            {
                                resSet = r.getResInfo(p2.getInt("ElecResId"));
                                resSet.next();
%>              
                                <input type="radio" id="pollz" name="pollz" value=<%=p2.getString("ElecCId")%>><%=resSet.getString("FirstName")%> <%=resSet.getString("LastName")%></input>
                                <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<%
                            }
%>
