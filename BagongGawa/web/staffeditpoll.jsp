...
%>
            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    ...
                    <h3 class="side">&nbsp;</h3>
                    <p>Edit <%=poll.getString("Pollname")%> Poll
                    <br> <ul></ul>
                    </p>            
                </div>
                ...
                <div class="contactform">
                    <form name ="login" onSubmit="return(checkForm())" action="processStaffEditPoll.jsp" method="get">
                        ...
                        <fieldset>
                            ...
                            <p>
                                ...
                                <input type="text" name="pollname" id="pollname" class="field" value=<%=poll.getString("Pollname")%>>
                            </p>
                            <p>
                                <label class="left" id="polldesctag">Poll Description:</label> 
                                <textarea name="textarea1" id="textarea1" rows="5" cols="47" wrap="soft"><%=poll.getString("Polldesc")%></textarea>
                            </p>
...
%>                                    
                            ...
                            <p> 
                                ...
                                <input type="hidden" id="hidid" name="hidid" value="<%=request.getParameter("pollid")%>"/>
<%
                        Polls db = new Polls();
                        ...
                        {
%>
                            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;* <%=p2.getString("pollchoicename")%></p>
<%
                        }
%>
                            </p>    
