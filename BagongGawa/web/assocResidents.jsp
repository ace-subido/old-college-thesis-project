...
<head>
    ...
    <title>Converge - Administrator : Community Residents</title>
</head>
...
<%	
    ...
    String divu = (String)session.getAttribute("divunit");
	
    CachedRowSet crset = db.getAllResidents();
...
%>
            ...
            <div class="main-content">
                ...
                <!-- Pagetitle -->
                <h1 class="pagetitle">Resident Accounts Information</h1>

                <!-- Content unit - One column -->
                <h1 class="side"><img src="icons/register_user.png" alt="Image description" title="Image title" />List of Resident Information</h1>
                <h3 class="side">&nbsp;</h3>
...
<%
            ...
            {
%>
		<div align="center"><h1>There are no Resident Accounts added yet </h1></div>			
<%	
            }
            else
            {	
%>
                <div class="column1-unit">
                    <form method="post" action="index.html">
                        <table width="636">
                            <tr>
                                <th width="94" class="top" scope="col">Resident Name </th>
                                <th width="89" class="top" scope="col">Account Username</th>
                                <th width="82" class="top" scope="col">Password</th>
                                <th width="80" class="top" scope="col">Address</th>
                                <!--<th width="100" class="top" scope="col">Capacity</th><th width="100" class="top" scope="col">Land Area</th><th width="100" class="top" scope="col">Usage Fee</th><th width="100" class="top" scope="col">Reservation Fee</th>-->
                                <th width="80" class="top" scope="col">Email Address</th>
                                <th width="92" class="top" scope="col">Contact No.</th>
                                <th width ="92"class="top" scope="col"></th>
                            </tr>
<%
                        while(crset.next())
                        { 
%>
                            <tr>
                                <td> <%=crset.getString("LastName")%> , <%=crset.getString("FirstName")%> </td>
                                <td><%=crset.getString("Username")%></td><td><%=crset.getString("Password")%></td>
                                <td><%=crset.getString("Address")%></td>
                                <td><%=crset.getString("EmailAdd")%></td>
                                <td><%=crset.getInt("HouseNum")%></td>
                                <td><a href="assocCreateRes.jsp?username=<%=crset.getString("Username")%>">Edit Details</a></td>
                            </tr>
<%
                        }
%>
...
%>		  
                        <br />
                        <p><input type="button" onclick="window.location.href='assocCreateRes.jsp?username=0'" name="submit" id="submit" class="button" value="Add New Resident Account" tabindex="6" /></p>
                    </form>
                </div>          
                <hr class="clear-contentunit" />       
            </div>
