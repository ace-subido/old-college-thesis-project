...
%>
            ...
            <div class="main-content">
                <h1 class="pagetitle">Setting up your Community's physical layout &nbsp;<font color="red"><b>1 </b></font>2 3 4</h1>
                <!-- Pagetitle -->
               <h1 class="side">Community Phases/Buildings</h1>
            <p> <h3 class="pagetitle">In this step you can setup your village's phases or buildings. 
       <br> <b>(eg. phases of your village village or buildings of your condominiums.)</b></h3></p>
       <br>
       <br><br>
                ...
                <div class="contactform">
                    ...
                    <fieldset>
                        <legend>Setup New Residential Phases/Buildings</legend>
                    <form action="processAssocSetupPhysical1.jsp">
                        <script type= "text/javascript">
                                <!--  
                                    function numDiv()
                                    {
                                        alert("Enter ONLY the NUMBER of divisions (example: 4 Buildings)");
                                    }
                                -->    
                                </script>
                                <p>
                                    <label class="left" id="villnumdivtag">Number of Divisions: (<a onclick="numDiv()"> ? </a>)</label>
                                    <input type="text" name="villnumdiv" id="villnumdiv" size ="5" value="" tabindex="1" title="Only numbers accepted"/></p>
                               <br><br><hr /><br><br>
                    <input class="button2" type=submit value="Submit"> <input type="button" onClick="window.location.href='assocSetupPhysicalLayout.jsp'" name="submit" id="submit" class="button2" value="<< Back" tabindex="6" />
