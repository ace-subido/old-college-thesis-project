...
<%
    ...
    CachedRowSet crset = db.getResInfo(Integer.parseInt(resId));
    Unit u = new Unit();
...
%>
                ...
                <div class="main-content">
                    ...
                    <h6>ADD DIRECTOR - RESIDENT NAME : Step 1 2 <font color="red">3</font> 4</h6>
    ...
    {%>
                    <div class="column1-unit">
                        <p>
                            ...
                            <h3 class="side">Community Status :<%=crset.getString("UserType")%></h3><br>
                        </p>  
                    </div>                          
                    <hr class="clear-contentunit" />
                    <%
