                ...
                <div class="column1-unit">
                    <div class="contactform">
                        <form name="facilitypicker">
                            <fieldset><legend>CHOOSE FACILITY</legend>
                                <p>
                                    <input type="hidden" name="as" value="<%=a%>"/>
...
%>
                ...
                <div class="column1-unit">   
                    <div class="contactform">                             
                        <form name="fg2" onSubmit="return(checkForm())" action="processResAddCheck.jsp">
                            <fieldset><legend>RESERVATION</legend>
                            <p>
                                <label for="contact_title" class="left">Date of Reservation:</label>  
                                <input onclick="ds_sh(this);" name="date" readonly="readonly" style="cursor: text" /><br /></p>
