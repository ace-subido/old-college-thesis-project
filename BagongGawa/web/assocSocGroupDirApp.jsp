...
%>
                       ...
                       %>
                <h1 class="block">"Simultaneous" Approvals</h1>
                <p>This setting allows the directors to simultaneously approve social group petitions without any chain or path of approvals.
                Directors having the "No" settings highlighted with light green will not approve any requests, but Directors with a "Yes" 
                status setting highlighted with light green will require for them to approve any social group request</p>
            ...
            <div class="column1-unit">
                    ...
                    <table width="536">
                            <tr>
                                ...
                                <th width="100" class="top" scope="col"><center>Yes Status</center></th>
                                <th width="100" class="top" scope="col"><center>No Status</center></th>
                            </tr>
<%
                        while(cr.next())
                        {
                           // String k = crset.getString("comDivisionName");
                            ...
                            CachedRowSet nameSet = e.getDivisionName2(Integer.parseInt(nn));
                            nameSet.next();
%>
                            <tr>
                                <td><center><%=cr.getString("DirName")%></center></td>
                                <td><center><%=nameSet.getString("comDivisionName")%></center></td>
                                <%if(cr.getString("socsim").equals("Yes")){
                                    %>
                                 
                                <td class="td2"><center><b>Yes</b></center></td>
                                <td><center><a href="processAssocSGDirAppNo.jsp?num=<%=cr.getInt("resID")%>">No</a></center></td>
                           
                                <%}else{%>
                                
                                <td><center><a href="processAssocSGDirAppYes.jsp?num=<%=cr.getInt("resID")%>">Yes</a></center></td>
                                <td class="td2"><center><b>No</b></center></td>                               
                            <%}%>
                            </tr>
                            <%
                        }
