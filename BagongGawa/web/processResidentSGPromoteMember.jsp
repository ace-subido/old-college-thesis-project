...
<html>
    ...
    <body>
        ...
        sg.promoteSGMember(a, b);
                
        Ace face = new Ace();
       String lp = "You have been you have been promoted to a social group administrator/moderator in the social group : "+ctv2.getString("SGName");
        String f = "["+ctv2.getString("SGName")+"] Member Position Promotion ";
    ...
    <script type= "text/javascript">
			<!--
			 var test = document.getElementById("newRes").value;
				...
				alert("The member has been notified");
