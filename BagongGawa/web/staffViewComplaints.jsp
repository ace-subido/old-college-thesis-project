   ...
   <!-- For alternative headers END PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">View Complaints and Suggestions</h1>

        <!-- Content unit - One column -->
        <!-- Content unit - One column -->
        <h1 class="block">Complaints and Suggestions Details</h1>
        <div class="column1-unit">
         
          <p class="caption">
            <textarea name="contact_message2" id="contact_message2" cols="76" rows="10"tabindex="5"></textarea>
          </p>
        </div>          
