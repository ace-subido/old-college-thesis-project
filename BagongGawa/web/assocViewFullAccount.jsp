...
<%      serviceTemplate t = new  serviceTemplate();
        ...
        int FamId = Integer.parseInt(request.getParameter("FamId"));
        CachedRowSet crset = db.getFamilyAccounts(FamId);
    Unit u = new Unit();
...
<%
                crset.next();
%>
                <h1 class="block">Head and Sub Accounts for residence <%=crset.getString("Address")%></h1>
...
<%
                        ...
                        {    
%>                         
                            <p>Enable | <a href="processAssocEnableDisableAccount.jsp?ResId=<%=crset.getString("ResId")%>&action=0">Disable</a></p>
<%
                        }
                        else
                        {    
%>                             
                            <p><a href="processAssocEnableDisableAccount.jsp?ResId=<%=crset.getString("ResId")%>&action=1">Enable</a> | Disable</p>
<%
                        }
%>
                        <hr class="clear-contentunit"/>
