...
<meta http-equiv="content-type" content="text/html; charset=utf-8" />
  ...
  <title>Converge - Administrator : Edit Facility Type</title>
  <script type= "text/javascript">
<!--
function checkForm2()
{
   	var name = document.fac.id;
...
%>
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Community Facilities : Edit <%=type%> Facility</h1>
		...
		<div class="contactform">
            <form name ="fac" method="post" onSubmit="return(checkForm())" action="processAssocDelFacType.jsp">
              <fieldset>
              <legend>&nbsp;Edit Facility&nbsp;</legend>
                <p>
                  <label for="vill_name" class="left">Facility Name:</label> 
                <input type="text" name="type" id="asso_name" class="field" value="<%=type%>" tabindex="1" /></p>
				<input type="hidden" name="id" value="<%=i%>"/>
                   <br />
				   <p><label for="vill_name" class="left">Mark as:</label> 
             		
             		<select class="combo" name="r">
					<option value="unavailable">unavailable</option>
					<option value="available">available</option>
					</select>
			  </p><br>
                   <p><input type="submit" name="submit" id="submit" class="button2" value="Save" tabindex="6" /> <input type="button" name="submit" id="submit" class="button2" value="Back" tabindex="6" onClick="window.location.href='assocCreateFacType.jsp'"/></p>
