...
<head>
    ...
    <!--
        function checkCat()
        {
            ...
            if (y.value == "0")
            {
                alert("Choose a CATEGORY of the bulletin board");
                 return(false);
...
%>
                ...
                <div align="center">&nbsp; &nbsp;&nbsp;<h2><font color="#666633">Bulletinboard Broadcast -> <%=cat%></font></h2><br></div>
                <div align="center" id="alertLoc"></div>
                <div align="center" id="alertName"></div>     
                <div align="center">
                    <br><br>
                    <form name="test" action="residentAddBulletinPost.jsp" method="get" onSubmit="return(checkCat())">
                        <label>Title of Post: </label><input type="text" id="bName" name="bName" value="" width="10px"><br><br>
                        <input type="hidden" id="bullCategory" name="bullCategory" value="<%=cat%>">
                        <!-- Include the Free Rich Text Editor Runtime -->
                        &nbsp;<textarea name="textarea1" id="textarea1">Type Here</textarea>
                        <br><br>
                        <div class="main-content">  
                            <div class="column1-unit">
                                <input class="button2" type="submit" value="Post to Bulletin">&nbsp;
                            </div>
                        </div>
                    </form>
                </div>
