...
<%
    ...
    CachedRowSet crcx = sg.getAllPetitionInvitesforSG(sgid);     
         
%>
                <!-- Pagetitle -->
                <input type="hidden" value="<%=a%>" id="as" name="as"/>
                <h1 class="pagetitle">Petition Group</h1>
                <div class="column1-unit">
            <h1 class="side"><img src="icons/Lui-tler.jpg" alt="Image description" title="Image title" /></h1>
                    <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, ut aliquip. orem ipsum dolor sit amet.           <br><br>  
                    <a href="residentPetitionMainPage.jsp?sgid=<%=sgid%>">Back to Petition Group Main Page</a></p>
                    
                </div>        
                <hr class="clear-contentunit" />    
                <div class="column1-unit">     
                    <h1 class="block">Currently Invited Residents</h1>
                    <%if(crcx.size()>0){
...
%>
            <br><center>      <table width="300">
                        <tr>
                            ...
                            <th width="150" class="top" scope="col">Status Of Invitation</th></tr>
<%}while(crcx.next()){
                    if(crcx.getInt("resID")!=a){
                        %>
   
                            <tr>
                            <td><%=crcx.getString("nme")%></td>
                            <% if(crcx.getString("status").equals("No")) {%>
                            <td>Haven't Accepted</td>
                            <%}else{
                                %>
                    ...
                    <hr class="clear-contentunit"/>
                    <h1 class="block">Invite More Residents</h1>
<%
                    if(vr==null)
                    {
%>
...
%>
                    ...
                    <table width="500">
                        <tr>
                            ...
                            <th width="100" class="top" scope="col"></th></tr>
<%
...
%>
                        <tr>
                            ...
                            <td><center><a href="processResidentSocPetAdd2Delete.jsp?num=<%=vr.elementAt(op).residentid%>">Remove</a></center></td>
                        </tr>
<%
                        }                
                }
%>
                ...
                <div id="jiankang" name="jiankang" class="column2-unit-left">        
                    <p>Search Residents:<br>
                        <input type="text" name="newRes" id="newRes" onkeyup="getResidents(this.value)"/>
                        <input type="button" name="SearchResident" value="Search Resident" onclick="displayResident2()"/>
                    </p>
                    <div id="suggest" name="suggest" style='width:300px; height:80px; overflow:auto'></div>        
                </div>
                <div id="jiankang2" name="jiankang2" class="column2-unit-right"></div> 
                <hr class="clear-contentunit"/>    <br>
                <p>  
                <input type="button" class="button" name="SearchResident" value="Invite" onclick="window.location.href='processResidentPetitionInviteList.jsp'"/>        </p>            </div>
        </div>
        <!-- C. FOOTER AREA -->      
        <div class="footer">
