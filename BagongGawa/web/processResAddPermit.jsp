...
<%
    ...
    int rID;
    if(type2.equalsIgnoreCase("staff"))
        rID = Integer.parseInt(request.getParameter("hidid"));
    else
        rID= (Integer)session.getAttribute("residentId");
    ...
    db.addResidentPermit(permitID,rID,applicationDate,field2,field3, field4, field5, field6, field7, field8, field9, field10, field11, field12, field13, field14, field15, field16, field17, field18, field19, field20,fieldSet.getString("path"),dfee);
...
%>   
        <script type= "text/javascript">
        <!--
            location = "staffSearchResident.jsp?criteria=0&search=All";
        -->
        </script>
<%
    }
