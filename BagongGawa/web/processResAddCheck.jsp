       ...
       if(temper2 - temper1 < sd1){
        ...
        if(a==1){%>
            ...
            <script type= "text/javascript">
				...
				alert("You can't reserve this facility for that date, you reached the amount of days needed before you can reserve.");
				location = "residentReserveAdd.jsp";
            ...
            db.addRes(restemp.frresdate, restemp.toresdate, residentID, facilityID);
			...
			<!--
				...
				alert("Reservation Successful! Fee will be added to your bill");
