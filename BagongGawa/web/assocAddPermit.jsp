...
%>
            ...
            <div class="main-content"> 
                ...
                <div class="column1-unit">
                    ...
                    <h1 class="side"><img src="icons/permits-icon2.jpg" alt="" />List of Permit Module</h1>
                    <h3 class="side">&nbsp;</h3>
                    ...
                    <p>&nbsp;        </p><hr class="content-unit"/><br>
                    <%
                        Permits p = new Permits();
                        CachedRowSet permitTemplate = p.getTemplate();
                    %>
                    <ul>
                    <%
                        while(permitTemplate.next())
                        {    
                    %>
                            <li> <a href="permitTemplate.jsp?templateID=<%=permitTemplate.getInt("pId")%>"><%=permitTemplate.getString("permitName")%> Template</a></li>
                    <%
                        }
                    %>
                        <li> <a href="assocAddNewPermit.jsp">Create New Permit</a></li>
                    </ul>
                </div>
            </div>
        </div>
