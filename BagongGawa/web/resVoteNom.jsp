...
<%
                ...
                int b = Integer.parseInt(request.getParameter("Nomid"));
                Election e = new Election();
                CachedRowSet crset = e.getSpecificNomination(b);
                crset.next();
                int check = e.getVoteTable(b,a);
%>
        <!-- Pagetitle -->
		...
		<div class="column1-unit">
                    ...
                    <h3 class="side">&nbsp;</h3>
                    <p>Here are the current nominations available to your community. Kindly read the nomination detail and vote by selecting a candidate and clicking 'Vote' after you select.</p>
                </div>
                <hr class="clear-contentunit" />
                <div class="column1-unit">
                    <center><h1><b><%=crset.getString("NomName")%></b></h1></center>
...
<%
                    ...
                    {
%>              
                        <center><h1><font color="#FF0000">You have already voted</font></h1>
...
<%
                    ...
                    {
%>              
                        <center><textarea name="textarea1" id="textarea1" rows="5" cols="47" readonly><%=crset.getString("NomDesc")%></textarea></center>
                        <p></p>
                        <p>
                        <div>
                        ...
                        <div align="center">
                            <table width="636">
                                <tr>
                                    ...
                                    <th width="200" class="top" scope="col"><div align="center">Address</div></th>
...
<%
                            ...
                            CachedRowSet resSet = r.getListRes("0","All");
...
%>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div align="center">
                                            <a href="processResidentNomination.jsp?NomresidentId=<%=resSet.getInt("ResId")%>&residentId=<%=a%>&nomid=<%=b%>">Nominate</a>
                                        </div>    
                                    </td>
