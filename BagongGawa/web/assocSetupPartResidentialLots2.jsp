...
%>
      ...
      <div class="main-content">
        <h1 class="pagetitle">Setting up your Community's physical layout &nbsp; 1 2<font color="red"><b> 3 </b></font>4</h1>
        ...
        <div class="column1-unit">
            ...
            <p> <h3 class="pagetitle">In this step you can setup your village's lots or units based on the number of divisions. 
       <br> <b>(eg. lots of your village or units of your condominium.)</b></h3></p>
       <br>
       <br><br>
       <div class="contactform">
           <form onSubmit="return(boob())" action="processAssocSetupPartResidentialLots2.jsp" method="get">
               <fieldset>
                   ...
                   &nbsp;&nbsp;<%
                       ...
                       <%
                        ...
                        {
                            %>
                            <option value="<%=cr.getInt("phasebd")%>" onclick='getBlFl(<%=cr.getInt("phasebd")%>)'><%=cr.getInt("phasebd")%></option>
                            <%
                        }
                       %>
                   </select>
         ...
         <br><br>
		<hr /><br /><br />
          <input type="submit" class="button2" value="Next >>" onClick="window.location.href='assocSetupPartResidentialLotsFinale.jsp'">
        <br><br>  
               <br>
