...
<head>
    ...
    <!--
        function checky()
        {
            var c = document.login.catsz;
            var m = document.login.folas;
            var y = document.login.rofl;
            if(c.value == "0")
            {
                alert("Choose from the categories");
                return(false);
            }
            else if(m.value == "")
            {
                alert("'Social Group Details' is a required Field");
                return(false);
            }
            else if(y.value == "")
            {
                alert("'Social Group Name' is a required Rield");
                return(false);
            }
        }
    -->
...
%>
                ...
                <div class="column1-unit">
                    <p class="center"><img class="center" src="./icons/sgRes-createpet1.jpg" alt="Image description" title="Image title" /></p>       
                    <p>The first step in creating a petition is to describe your petition request for such a social group. Then you can move on to the next step  </p>              
                </div>
                <hr class="clear-contentunit" />
                <h1 class="block">1 - Petition Details</h1><br>
                <div class="column1-unit">
                    <div class="contactform">
                        <form name ="login" onSubmit="return(checky())" action="processResidentSocPetAdd.jsp" method="get">
                            <fieldset>
                                <p> <label for="vill_name" class="left">Social Group Name:</label> 
                                <input type="text" name="rofl" id="rofl" class="field" value=""/></p>
                                <p> <label for="vill_name" class="left">Social Group Category:</label> 
<%
                                if (crset.size() > 0)
                                {                
%>
                                <select name="catsz" id="catsz" class="combo">
...
%>
                                ...
                                <p><input type="submit" name="button" class="button2" value="Submit Petition"/></p>
                            </fieldset>
                        </form>
                    </div>                   
                </div>
