...
<head>
    ...
    <script type="text/javascript"> 
        function checkForm()
        {
            var name = document.form1.dv;
            if(name.value == "")
            {
                alert("Fill in division name");
                return false;
            }
        }
    </script>  
            ...
            <div class="main-content">
                ...
                <div class="column1-unit">
                    ...
                    <div class="contactform">
                        <form name="form1" onSubmit="return(checkForm())" method="get" action="proccessAssocCreateComManDiv.jsp">
                            <fieldset>
                                <legend>Add New Community Management Division</legend>
                                <p>
                                    <label class="left">Division Name:</label>
                                    <input name="dv" class="field" value=""/>
                                </p>
                            </fieldset>
                            <p>
                                <input type="submit" class="button2" value="Add"/> <input type="button" onclick="window.location.href='assocVillInfo.jsp'" class="button2" value="Back"/></p>
                        </form>
                    </div>     
                </div>         
