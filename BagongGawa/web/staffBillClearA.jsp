...
%>
        ...
        ResidentObject ro = (ResidentObject)session.getAttribute("ClearSelectedResident");
...
java.util.Date yey2 = (java.util.Date)session.getAttribute("ABPrdEnd");
        ...
        %>
                <!-- Pagetitle -->
                <h1 class="pagetitle">Community Billing Management : Bill Clearance</h1>
		<div class="column1-unit">
                    <h1 class="side"><img src="icons/calculator-accept-128x128.png" alt="Image description" title="Image title" /></h1>
                    <p>This is the bill clearance management for association dues bills. Search the resident and view his unpaid bills. 
                    Afterwards you can select which bill to clear by clicking "Clear" and selecting the payment type. 
                    You can also choose to put interest penalties (by percentage) if there are any set by the administrator. </p>
         ...
         <hr class="clear-contentunit"/>
          ...
          <br>          
          <p><input type="text" id="text2" name="text2" onkeyup="getResidentAClear(this.value)"> &nbsp;<input type="button" value="Search Resident" onclick='displayAClearResident()'></p>
          <p>Results:</p>
          <br><div id="rodList2" name="rodList2">
             
          </div>
           
        </div>
        <div class="column2-unit-right" id="list2">         
       ...
       <%
        if(ro!=null){
            CachedRowSet cr = b.getAllUnPaidBillsOFRESID(ro.residentid); 
            ...
            <center><table>
                                ...
                                <%while(cr.next()){
                                    ...
                                    mom = cr.getDouble("balance");
                                       %>
                                <tr>
                                    <td class="td2"><a href="viewBill.jsp?num=<%=cr.getInt("bid")%>" target="_blank"><%=cr.getInt("bid")%></a></td>
                                    <%
                 ...
                 <div class="contactform">
                    <form name="rsaz" onsubmit="return(checkster())"action="processStaffBillClearAssoc.jsp" method="get">
                       <fieldset><legend>PAYMENT : ASSOCIATION DUES BILL</legend>
