...
%>
		...
		<div class="column1-unit">
                    <h1 class="side"><img src="icons/facilities_icon.jpg" width="150" alt="Image description" title="Image title" />List of Services</h1>
                    <h3 class="side">&nbsp;</h3>
                    <p>You can choose from the services of Converge that your community can use. The Division that will handle allows you to choose who will handle which service.</p>
                </div> 
...
%>
                            ...
                            <tr>
                                <td>
                                    <div align="center">
                                        <input disabled name="billingCheckBox7" type="checkbox" id="billingCheckBox7" value="Nope" 
<%
                                        if(c.getString("billing").equals("Yes"))
                                        {    
%> 
...
%>
                                            />
                                        <input type="hidden" name="billingCheckBox7" id="billingCheckBox7" value="Yes">
                                    </div>
                                </td>
                                <td><div align="center">Billing</div></td>
                            </tr>
