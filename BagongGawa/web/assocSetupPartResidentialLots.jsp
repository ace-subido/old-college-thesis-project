...
%>
      ...
      <div class="main-content">
        <h1 class="pagetitle">Setting up your Community's physical layout &nbsp;1 <font color="red"><b>2</b></font> 3 4</h1>
        ...
        <div class="column1-unit">
            <h1 class="side">Community Residential Blocks/ Floors</h1>
            <p> <h3 class="pagetitle">In this step you can setup the divisions of your village's phases or buildings. 
       <br> <b>(eg. blocks of your village or floors of your condominium.)</b></h3></p>
            
       <br><br>
       <div class="contactform">
           <form name="form1" onSubmit="return(boob())" action="processAssocSetupPartResidentialLots.jsp" method="get">
               <fieldset>
                  ...
                  %>
                            <p>
                                <label class="left"><b><font size="3">Phases</font></b></label> &nbsp;
                                type the number of Blocks for each phase.
                             </p>       
                                        
                                        <%
                                          while(crset.next())
                                          {
                                              int i = crset.getInt("Division");
                                          %>
                                          ...
                                          <%
                                              ...
                                              {
                                        %>
                                        <p><label class="left" id="<%=x%>tag">phase <%=x%></label> 
                  ...
                  %>
                            <p>
                                <label class="left"><b><font size="3">Building</font></b></label> &nbsp;
                                type the number of Floors for each Building.
                             </p>       
                                        ...
                                        <%
                                         ...
                                         %>
                                          ...
                                          <%
                                              ...
                                              {
                                        %>
                                        <p><label class="left" id="<%=x%>tag">Building <%=x%></label> 
                                            <input type="text" name="<%=x%>" id="<%=x%>">
                                        </p>
                                        <%
                                                    x++;
