...
<%
                ...
                java.util.Date yey3 = (java.util.Date)session.getAttribute("ABPrdEq");
                String ggg = "";
                if(yey3 != null)
                {
                ...
                int days = (Integer)session.getAttribute("DAYSZZ");    
%>
                <!-- Pagetitle -->
                <h1 class="pagetitle">Community Billing Management : Association Dues</h1>
...
%>        
                ...
                <div class="column2-unit-right">
                    ...
                    <p><br> <a href="staffGenAssocBill.jsp">Generate Association Bill Batch</a><br>
                    <a href="staffBillClearA.jsp">Resident Bill Clearance</a><br>                               
                    <a href="staffBillReportA.jsp">Bill Reports</a><br><br></p>
                </div>
            </div>
        </div>
        <!-- C. FOOTER AREA -->      
