    ...
    if(ctv.size()>0)
    {
        ...
        { 
            ...
            { 
                ...
                response.getWriter().write("<p>&nbsp;&nbsp;<a href='processResidentJoinSocGroup.jsp?sgid="+ctv.getInt("SGID")+"'>Join this Group</a> | <a href='residentSocialGroupMainPage.jsp?sgid="+ctv.getInt("SGID")+"'>View Group Page</a></p>");
