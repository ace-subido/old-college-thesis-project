...
%>
            ...
            <h1 class="pagetitle">Reservation Service</h1>
                <div class="column1-unit">
                    <h1 class="side"><img src="icons/reservation-icon.jpg" alt="Image description" title="Image title" />List of Newsletter Applications</h1>
                    <h3 class="side">&nbsp;</h3>
...
<%
                ...
                {
%>
                    <h1>No pending newsletters</h1><br>
<% 
                }
                else
                {
%>
                ...
                <form action = 'processNewsletterApproveReject.jsp' method='get'>
<%
                    //v1 = v;       
                nlCRS.next();
                for(int i = 0; i < nlCRS.size(); i++)
                {   
%>
<input type=checkbox name=<%=nlCRS.getString("entryID") %> />
Newsletter - Requested by <%=nlCRS.getString("author") %> - <%=nlCRS.getString("nlstatus") %> - <%=nlCRS.getString("subject") %><br>
<%
                nlCRS.next();
                }
...
%> 
                <input type=submit name=submitNewsletter value="Approve"/>
                <input type=submit name=submitNewsletter value="Reject"/>
                </form>
                <br>        
                </div>
                <hr class="clear-contentunit" />
